class Target < ISM::Software
    ...
    def extract
        super
        moveFile("#{workDirectoryPath}/ISM-Alpha-13022023","#{workDirectoryPath}/Alpha-13022023")
    end
    ...
    def prepareInstallation
        ...
        copyDirectory("#{workDirectoryPath}/Alpha-13022023","#{builtSoftwareDirectoryPath}#{Ism.settings.rootPath}usr/share/ism")
    end
